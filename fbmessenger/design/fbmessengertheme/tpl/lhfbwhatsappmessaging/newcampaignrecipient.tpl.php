...
<form action="<?php echo erLhcoreClassDesign::baseurl('fbwhatsappmessaging/newcampaignrecipient')?>/<?php echo $campaign->id?>/<?php if ($item->id > 0) : ?><?php echo $item->id?><?php endif;?>" ng-non-bindable method="post" target="_blank" onsubmit="return lhinst.submitModalForm($(this))">
    ...
    <?php include(erLhcoreClassDesign::designtpl('lhfbwhatsappmessaging/parts/form_campaign_recipient.tpl.php'));?>
