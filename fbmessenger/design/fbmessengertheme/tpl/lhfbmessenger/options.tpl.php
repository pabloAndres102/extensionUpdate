<form action="" method="post" ng-non-bindable>
    ...
    <div class="form-group">
        <label>Identificador de Cuenta Empresarial de WhatsApp</label>
    ...
    <div class="form-group">
        <label>Identificador del número de teléfono empresarial</label>
        <input class="form-control form-control-sm" type="text" name="business_phone_id" value="<?php (isset($fb_options['business_phone_id'])) ? print htmlspecialchars($fb_options['business_phone_id']) : print '' ?>" />
    </div>

    <div class="form-group">
        <label>Identificador de la app</label>
        <input class="form-control form-control-sm" type="text" name="app_id" value="<?php (isset($fb_options['app_id'])) ? print htmlspecialchars($fb_options['app_id']) : print '' ?>" />
    </div>
