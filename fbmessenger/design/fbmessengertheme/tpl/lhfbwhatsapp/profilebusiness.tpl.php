                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="url" class="form-control" id="website1" name="website1" placeholder="https://www.ejemplo.com">
                                    </div>
                                    <div class="form-group">
                                        <label for="website2">Sitio Web 2:</label>
                                        <input type="url" class="form-control" id="website2" name="website2" placeholder="https://www.otroejemplo.com">
                                    </div>
                                </div>
                            </div>
                        </div>
